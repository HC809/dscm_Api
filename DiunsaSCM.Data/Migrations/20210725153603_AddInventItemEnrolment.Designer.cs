...
namespace DiunsaSCM.Data.Migrations
{
    ...
    [Migration("20210725153603_AddInventItemEnrolment")]
    partial class AddInventItemEnrolment
    {
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasAnnotation("Relational:Sequence:.InventItemEnrolments", "'InventItemEnrolments', '', '1', '1', '', '', 'Int64', 'False'")
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.CommercialAgreement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.InventItem", b =>
                {
                    ...
                    b.Property<bool>("BlckedForInventory")
                        .HasColumnType("bit");

                    b.Property<bool>("BlckedForPurch")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.InventItemEnrolment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("InventItemEnrolment");
                });

            modelBuilder.Entity("DiunsaSCM.Core.Entities.InventItemEnrolmentDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("InventItemEnrolmentId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("InventItemEnrolmentId");

                    b.HasIndex("InventItemId");

                    b.HasIndex("ItemBarcodeId");

                    b.ToTable("InventItemEnrolmentDetail");
                });
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.InventItemPurchPriceLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("InventItemPurchPriceLog");
                });
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.PurchQuotationCreator", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("PurchQuotationCreator");
                });

            modelBuilder.Entity("DiunsaSCM.Core.Entities.PurchQuotationCreatorRole", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("PurchQuotationCreatorId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PurchQuotationCreatorId");

                    b.HasIndex("PurchRoleId");

                    b.ToTable("PurchQuotationCreatorRole");
                });
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.PurchRoleItemHierarchy", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("PurchRoleItemHierarchy");
                });
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.Vendor", b =>
                {
                    ...
                    b.Property<string>("CellphoneNumer")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("SinglePurchOrderShipment")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.VendorItemHierarchy", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.InventItemEnrolmentDetail", b =>
                {
                    ...
                    b.HasOne("DiunsaSCM.Core.Entities.InventItemEnrolment", "InventItemEnrolment")
                        .WithMany()
                        .HasForeignKey("InventItemEnrolmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.PurchQuotationCreatorRole", b =>
                {
                    b.HasOne("DiunsaSCM.Core.Entities.PurchQuotationCreator", "PurchQuotationCreator")
                        .WithMany("PurchQuotationCreatorRoles")
                        .HasForeignKey("PurchQuotationCreatorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.PurchRoleItemHierarchy", b =>
                {
                    b.HasOne("DiunsaSCM.Core.Entities.ItemHierarchy", "ItemHierarchy")
                        .WithMany()
                        .HasForeignKey("ItemHierarchyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
