...
namespace DiunsaSCM.Data.Migrations
{
    ...
    [Migration("20210205121912_CompletedLogEntry")]
    partial class CompletedLogEntry
    {
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.PurchOrderShipmentHeader", b =>
                {
                    ...
                    b.Property<long?>("PreparationCurrentShippingRouteStepId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PreparationCurrentShippingRouteStepId");
            ...
            modelBuilder.Entity("DiunsaSCM.Core.Entities.PurchOrderShipmentHeader", b =>
                {
                    ...
                    b.HasOne("DiunsaSCM.Core.Entities.ShippingRouteStep", "PreparationShippingRouteStep")
                        .WithMany()
                        .HasForeignKey("PreparationCurrentShippingRouteStepId");
